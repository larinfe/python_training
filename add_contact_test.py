...
class AddContactTest(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        driver.find_element_by_name("firstname").send_keys("asdasd")
        driver.find_element_by_name("middlename").clear()
        driver.find_element_by_name("middlename").send_keys("asddqqq")
        driver.find_element_by_name("lastname").click()
        driver.find_element_by_name("lastname").clear()
        driver.find_element_by_name("lastname").send_keys("asdasdasdaq")
        driver.find_element_by_name("nickname").click()
        driver.find_element_by_name("nickname").clear()
        driver.find_element_by_name("nickname").send_keys("111111")
